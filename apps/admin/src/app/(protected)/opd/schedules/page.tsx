      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {!providerId ? (
          ...
          <form onSubmit={handleCreate} className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            {createError ? (
              <div className="md:col-span-2 xl:col-span-4 rounded-md border border-[hsl(var(--status-destructive-border))] bg-[hsl(var(--status-destructive-bg))] px-3 py-2 text-sm text-[hsl(var(--status-destructive-fg))]">
                {createError}
              </div>
            ) : null}
