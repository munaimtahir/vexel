...
export const FEATURE_FLAG_REGISTRY: FeatureFlagDefinition[] = [
  ...
  {
    key: 'opd.doctor_master',
    app: 'opd',
    group: 'app-features',
    label: 'Doctor Master',
    description: 'OPD doctor master CRUD for registration workflow.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  {
    key: 'module.opd.doctorProfiles',
    app: 'opd',
    group: 'app-features',
    label: 'OPD Doctor Profiles',
    description: 'Enable OPD doctor profile configuration and operator doctor selection.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  {
    key: 'module.opd.receipt',
    app: 'opd',
    group: 'app-features',
    label: 'OPD Receipt',
    description: 'Enable deterministic OPD consultation receipt generation.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  {
    key: 'module.opd.prescription',
    app: 'opd',
    group: 'app-features',
    label: 'OPD Prescription',
    description: 'Enable OPD prescription workflow and document generation.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  {
    key: 'module.opd.printSummary',
    app: 'opd',
    group: 'app-features',
    label: 'OPD Print Summary',
    description: 'Enable OPD summary rendering in print payload.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  },
  {
    ...
    group: 'app-features',
    label: 'Intake',
    description: 'OPD intake command flow for vitals and chief complaint.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  },
  {
    ...
    app: 'opd',
    group: 'app-features',
    label: 'Prescription Publish',
    description: 'OPD prescription publish command and PDF generation.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: false,
  ...
  {
    key: 'opd.immediate_print_after_publish',
    app: 'opd',
    group: 'app-features',
    label: 'Immediate Print After Publish',
    description: 'Open/download OPD prescription immediately after publish.',
    valueType: 'boolean',
    status: 'implemented',
    buildStatus: 'built',
    defaultValue: true,
    dependsOn: ['module.opd', 'opd.prescription'],
  },
  {
