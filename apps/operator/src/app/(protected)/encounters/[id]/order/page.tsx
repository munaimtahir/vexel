    ...
    return (
      <div>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <Link href={`/encounters/${id}/sample`}
    ...
    <div>
      ...
      <div style={{ background: 'hsl(var(--card))', borderRadius: '8px', border: '1px solid hsl(var(--border))', padding: '24px', maxWidth: '600px' }}>
          ...
          <div style={{ display: 'grid', gap: '8px', marginBottom: '20px' }}>
            {tests.map((t: any) => (
              <label key={t.id} style={{
                ...
                background: selectedTests.has(t.id) ? 'hsl(var(--status-info-bg))' : 'white',
              }}>
                <input
                  type="checkbox"
        ...
        {selectedTests.size > 0 && (
          <div style={{ background: 'hsl(var(--status-info-bg))', border: '1px solid hsl(var(--status-info-border))', borderRadius: '6px', padding: '10px 16px', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button
            ...
            style={{
              flex: 1, padding: '12px',
              background: submitting || selectedTests.size === 0 ? 'hsl(var(--muted-foreground))' : 'hsl(var(--primary))',
