...
export default function EncounterDetailPage() {
  ...
  useEffect(() => {
    fetchEncounter().finally(() => setLoading(false));
  }, [id]);
      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '24px', flexWrap: 'wrap' }}>
        ...
        {status === 'verified' && (
          <Link
            ...
            style={{ padding: '10px 20px', background: '#7c3aed', color: 'white', borderRadius: '6px', textDecoration: 'none', fontSize: '14px', fontWeight: 600 }}
          >
            Publish Report
          </Link>
        )}
