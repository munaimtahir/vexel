  ...
  if (encounter.status !== 'resulted') {
    return (
      <div>
        ...
        <IdentityHeader patient={encounter.patient} encounterId={encounter.id} status={encounter.status} createdAt={encounter.createdAt} />
      ...
      {showModal && (
        <div style={{
          ...
          <div style={{ background: 'white', borderRadius: '8px', padding: '32px', maxWidth: '440px', width: '100%', margin: '16px' }}>
            <h3 style={{ margin: '0 0 12px', fontSize: '18px', fontWeight: 700, color: '#1e293b' }}>Verify Results</h3>
            <p style={{ color: '#64748b', marginBottom: '24px' }}>
              Verify all results for <strong>{encounter.patient.firstName} {encounter.patient.lastName}</strong>? This cannot be undone.
            </p>
