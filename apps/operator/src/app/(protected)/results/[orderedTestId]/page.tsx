    ...
    <div style={{ paddingBottom: '80px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
          <Link href="/results" style={{ color: '#2563eb', fontSize: '14px', textDecoration: 'none', fontWeight: 500 }}>
            ← Back to Results
          </Link>
          {!specimenReady && (
            <Link
        ...
        <div style={{
          ...
          <div>
            ...
            <span style={{ marginLeft: '8px' }}>
              <Link href="/sample-collection" style={{ color: '#2563eb', fontSize: '13px' }}>Go to Sample Collection →</Link>
            </span>
          </div>
        </div>
      )}
