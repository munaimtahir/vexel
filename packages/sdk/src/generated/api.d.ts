...
export interface paths {
    ...
    "/reports/registrations": {
        ...
        /** Date-range patient registration report (list + daily counts) */
        get: operations["getRegistrationsReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/patient-history/{patientId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Cumulative visit/order/document history for one patient */
        get: operations["getPatientHistoryReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/worklist-status": {
        ...
        /** Lab order counts by status, plus a pending/aging list */
        get: operations["getWorklistStatusReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/encounter-timeline/{encounterId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Full chronological workflow action log for one encounter */
        get: operations["getEncounterTimelineReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/staff-activity": {
        ...
        /** Staff activity summary (actions per user) over a date range */
        get: operations["getStaffActivityReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/exceptions": {
        ...
        /** Status-change/exception report (returns-for-correction, cancellations) */
        get: operations["getExceptionsReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/financial/daily-collection": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Daily cash collection report, by payment mode */
        get: operations["getDailyCollectionReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/financial/outstanding-dues": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Outstanding/unpaid balances report */
        get: operations["getOutstandingDuesReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/reports/financial/discounts": {
        ...
        /** Discounts-applied report over a date range */
        get: operations["getDiscountsReport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/opd/canonical-appointments": {
        ...
        /** List canonical tenant-scoped OPD appointments */
        get: operations["listCanonicalOpdAppointments"];
        put?: never;
        /** Book a canonical OPD appointment */
        post: operations["createCanonicalOpdAppointment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/opd/canonical-appointments/{appointmentId}:check-in": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Check in a canonical OPD appointment */
        post: operations["checkInCanonicalOpdAppointment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/opd/canonical-appointments/{appointmentId}:cancel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Cancel a canonical OPD appointment */
        post: operations["cancelCanonicalOpdAppointment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    getPatientHistoryReport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Patient history report */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getWorklistStatusReport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Worklist status report */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getEncounterTimelineReport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Encounter timeline report */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getOutstandingDuesReport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Outstanding dues report */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listCanonicalOpdAppointments: {
        ...
        requestBody?: never;
        responses: {
            /** @description Canonical appointment list */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createCanonicalOpdAppointment: {
        ...
        responses: {
            /** @description Canonical appointment booked */
            201: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            401: components["responses"]["Unauthorized"];
            403: components["responses"]["Forbidden"];
            /** @description Slot conflict or unavailable doctor schedule */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    checkInCanonicalOpdAppointment: {
        parameters: {
            query?: never;
            header?: never;
            path: {
